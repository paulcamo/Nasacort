...
var animations = {
    ...
    pos : {
        ...
        slide2 : { 'in' : $('#slide03').offset().top - $(window).innerHeight() + $('#slide03').outerHeight() / 5, 'out' : $('#slide03').offset().top - $(window).innerHeight() + $('#slide03').outerHeight() / 5.5, 'half' : $('#slide03').outerHeight() / 2, 'spot' : $('#slide03').offset().top - ($('#slide03').outerHeight() / ($(window).innerWidth() >= 1410 ? 3 : 3.7))},
        slide3 : { 'in' : $('#slide04').offset().top - $(window).innerHeight() + $('#slide04').outerHeight() / 5, 'out' : $('#slide04').offset().top - $(window).innerHeight() + $('#slide04').outerHeight() / 5.5, 'half' : $('#slide04').outerHeight() / 2, 'spot' : $('#slide04').offset().top - ($('#slide04').outerHeight() / ($(window).innerWidth() >= 1410 ? 3 : 5))},
